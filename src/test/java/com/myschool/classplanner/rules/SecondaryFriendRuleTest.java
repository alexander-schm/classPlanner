 ...
 */
public class SecondaryFriendRuleTest {
    ...
    public void setUp() {
        ...
        pupil.setSecondaryFriend(friend);
    }
    ...
    public void friendInOtherClassDoesReduceScore() {
        ...
        int rulesFired = session.fireAllRules(match -> "secondaryFriends".equals(match.getRule().getName()));
