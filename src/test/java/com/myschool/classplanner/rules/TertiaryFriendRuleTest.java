 ...
 */
public class TertiaryFriendRuleTest {
    ...
    public void setUp() {
        ...
        pupil.setTertiaryFriend(friend);
    }
    ...
    public void friendInOtherClassDoesReduceScore() {
        ...
        int rulesFired = session.fireAllRules(match -> "tertiaryFriends".equals(match.getRule().getName()));
